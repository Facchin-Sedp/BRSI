...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script src="Scripts/Transferts.js"></script>

    <div class="container container-fluid">

        <div class="row">
            <div class="col-lg-6">
                <input id="txtNomeFile" class="form-control" value="" placeholder="Inserisci nome file" />
                
            </div>
            <div class="col-lg-6">
                <button id="btnTxFile" class="btn btn-success">Avvia Trasferimento</button>
            </div>
        </div>
    </div>
