        ...
        <ol class="round">
            <li class="one">
                <h2>Pannello di monitoraggio</h2>            
                 per visualizzare il pannello di monitoraggio <a class="btn btn-success" role="button" style="color:white" href="/panel.aspx">Dashboard</a>
            </li>
            <li class="two">
                <h2>Configurazione</h2>
                Vai alla pagina di configurazione
                <a class="btn btn-success" role="button" style="color:white" href="/configuration.aspx">Configurazione</a>
            </li>
            <li class="three">
                <h2>Schedulazioni</h2>
                Gestisci le schedulazioni dei trasferimenti (S)FTP programmati                
                <a class="btn btn-success" role="button" style="color:white" href="/Scheduled.aspx">Schedulazioni</a>
            </li>
          <li class="four">
                <h2>Trasferimenti FTP</h2>
                Avvia Trasferimento (S)FTP  di files                
                 <a class="btn btn-success" role="button" style="color:white" href="/Transferts.aspx">Trasferimenti FTP</a>
            </li>
