...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <asp:Panel ID="PnlLogout" runat="server" Visible="true" style="text-align:center">
        <h3>è necessario effettuare l'accesso per visualizzare le opzioni disponibili</h3>
